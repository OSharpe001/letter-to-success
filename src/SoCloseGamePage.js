// SO CLOSE TO GETTING COMPUTER PLAYER BEHAVIOR TO ACT RIGHT!!!
  ...
  computerPlayersBehavior(() => {
    if (currentPlayer.name.indexOf("Computer")!==0) {
      ...
      if (vowels.indexOf(computerChoice)>=0) {
        ...
        console.log("GAMEPAGE.JS COMPUTERPLAYERBEHAVIOR NEWSPIN VALUES: ", newSpin.type, newSpin.value, newSpin.prize)
        const badNews= ()=> {
        ...
        setTimeout(hitOrMiss,8000);
      }; 

      // console.log("A RANDOM NUMBER(0-9)", Math.floor(Math.random() * 10), "COMPUTER'S DIFFICULTY LEVEL", props.settingsData.computerDifficultyLevel)
        ...
        <div className="readout">
          ...
          <div className={"interface"}>
            ...
            <div className="spin-solve-buy">
              <form className={(!wheelValue && !vowelInterface) || pauseControls?"hidden":!vowelInterface?"left":"right"}>
