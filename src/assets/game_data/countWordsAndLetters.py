...
mostWords = mostLetters = 0
mostWordsPuzzle = mostLettersPuzzle = ""
for puzzle in puzzles:
    wordAmount = sum([1 for word in puzzle.split(" ")])
    if wordAmount > mostWords:
        mostWords = wordAmount
        mostWordsPuzzle = puzzle
    if len(puzzle) > mostLetters:
        mostLetters = len(puzzle)
        mostLettersPuzzle = puzzle

print(f"{mostLettersPuzzle} - has {mostLetters} letters.")
